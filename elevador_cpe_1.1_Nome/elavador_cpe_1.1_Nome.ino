...
void loop() {    
     ...
     if (digitalRead(SALVASOBE) == HIGH && estado==1 && verificadescida==1){ //salva subida
     ...
     else if (digitalRead(SALVADESCE) == HIGH && estado==1 && verificadescida==0){ //salva descida           
...
// ----- liga, desliga e reset ------ 
    ...
    else if ( estado == 0 && digitalRead(LIGA) == HIGH ) { //liga
     ...
     else if ( estado == 1 && digitalRead(LIGA) == HIGH ) { //Desliga
        while (digitalRead(LIGA) == HIGH); 
         analogWrite(LPWM_Output, 0); 
         analogWrite(RPWM_Output, 0); 
         lcd.setBacklight(LOW); 
     ...
     else if(estado == 1 && digitalRead(RESET) == HIGH){ //reset
